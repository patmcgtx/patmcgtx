...
You can find my most current [side project](https://github.com/patmcgtx/mapplus) that digs into SwiftUI, SwiftData, MapKit, CoreLocation, and Swift Testing with a layered, reactive, MVVM [architecure](https://github.com/patmcgtx/mapplus/blob/main/MapPlus/ARCHITECTURE.md).
...
I also like play around with [useful scripts](https://github.com/patmcgtx/scrivener2dayone) to automate my creative projects.
...
I'm a [proud dad](https://mcgkids.blog), and they're basically functioning adults now.
